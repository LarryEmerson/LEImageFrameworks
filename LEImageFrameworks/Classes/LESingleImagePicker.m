...
-(void) leAdditionalInits{
    ...
    scrollView=[[UIScrollView alloc] initWithAutoLayoutSettings:[[LEAutoLayoutSettings alloc] initWithSuperView:self.leViewBelowCustomizedNavigation Anchor:LEAnchorInsideCenter Offset:CGPointZero CGSize:CGSizeMake(LESCREEN_WIDTH, LESCREEN_WIDTH/curAspect)]];
    ...
    float minHA=LESCREEN_WIDTH*1.0/curAspect/curImage.size.height;
    ...
    if(curAspect==1){
        UIView *viewCover=[UIView new].leSuperView(self.leViewBelowCustomizedNavigation).leAnchor(LEAnchorInsideCenter).leSize(self.leViewBelowCustomizedNavigation.bounds.size).leAutoLayout;
